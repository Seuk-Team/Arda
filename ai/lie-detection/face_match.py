...
# 코사인 유사도 문턱. LFW 400쌍 실측:
#
#     같은 사람 199쌍   평균 +0.590   하위 5% +0.377
#     다른 사람 200쌍   평균 +0.002   최대    +0.197
#
# **"다르다" 쪽을 훨씬 보수적으로 잡는다.** 놓친 대리응시는 면접관이 눈으로 잡을
# 여지가 남지만, 멀쩡한 지원자를 의심하는 것은 되돌릴 데가 없다. 0.15 아래는
# 같은 사람 쌍에서 한 번도 나오지 않은 구간이다.
#
