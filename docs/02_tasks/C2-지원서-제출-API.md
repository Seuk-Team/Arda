...
- [docs/00_overview/01-erd.md](../00_overview/01-erd.md) — `applications` · `stage_history` 표
- [docs/00_overview/02-api.md](../00_overview/02-api.md) — "지원 — 공개 (C)" 표
...
```
0단계.
backend/app/models.py 의 Application·StageHistory, docs/00_overview/01-erd.md 의 applications 표,
docs/00_overview/02-api.md 의 "지원 — 공개 (C)" 표, frontend/mockups/mockup-apply.html 을 읽어라.
