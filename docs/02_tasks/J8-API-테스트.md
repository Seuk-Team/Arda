...
[J4 CI](../00_overview/06-weekly.md) 가 붙으면 이 테스트가 PR 마다 자동으로 돈다. 그때 가치가 나온다.
...
- [docs/00_overview/02-api.md](../00_overview/02-api.md) — 덮을 엔드포인트 목록
...
```
0단계.
backend/app/api/ 아래 라우터 전부와 docs/00_overview/02-api.md 를 읽어라.
