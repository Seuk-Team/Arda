    ...
    def complete(
        ...
        *,
        ...
        return CompletionResult(
            ...
            cost_usd=0.0,
            # Ollama 는 잘림을 done_reason "length" 로 준다. Anthropic 의
            # "max_tokens" 와 뜻이 같으므로 호출부가 한 값만 보게 맞춰 준다.
            stop_reason=(
                "max_tokens" if data.get("done_reason") == "length" else data.get("done_reason")
            ),
        )
